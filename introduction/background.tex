...
\newpage
また, 清岡ら\cite{kiyooka-si}(以下｢先行研究｣と称する)により, \figref{Fig:kiyooka-si}に示すような手法を用いて, 経路上だけでなく経路から離れた状態も学習することが, 経路追従行動を模倣する上で有効であることが示された. 
...
\section{関連研究}
Yunpeng Pan\cite{batch}らは, \figref{Fig:batch1}のようなシステムでバッチ学習とオンライン学習を用いて, 高度なセンサーを備えたモデル予測制御を模倣した. これにより, \figref{Fig:batch2}のように高速でオフロードを自律走行することに成功した. 
