...
\newpage
  ...
  \caption{Data collected by the simulator in the learning phase from \cite{offline}}
...
\begin{figure}[h]
  ...
  \caption{Location and orientation of the robot in the experiments from \cite{offline}}
...
\begin{figure}[h]
  ...
  \caption{Loss value in the experiment from \cite{offline}}
